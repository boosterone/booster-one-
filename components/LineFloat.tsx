...
export default function LineFloat() {
  ...
  return (
    <div
      className={`fixed bottom-6 right-4 sm:right-6 z-50 flex flex-col items-end gap-2 transition-all duration-700 ${
    ...
    >
      ...
      >
        <div className="bg-white text-[#080808] text-xs font-bold px-3 py-2 rounded-lg shadow-lg whitespace-nowrap relative">
          LINEで気軽に相談！30分以内に返信
